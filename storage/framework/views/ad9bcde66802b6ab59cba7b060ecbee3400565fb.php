        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="<?php echo e(route('update', $user->id)); ?>">
                            ...
                            <div class="col-md-6">
                                <select class="form-control" name="isadmin">
                                    <?php if($user->isadmin == 1): ?>
                                        <option value="1"><?php echo e("Admin"); ?> </option>
                                    <?php else: ?>
                                        <option value="0"><?php echo e("User"); ?></option>
                                    <?php endif; ?>
